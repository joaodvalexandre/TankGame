...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown("escape") && !isMenuOpen)
        {
            Time.timeScale = 0.0f;
            OpenMenu();
        }
        else if (Input.GetKeyDown("escape") && isMenuOpen)
        {
            Time.timeScale = 1.0f;
            CloseMenu();
        }
    ...
    {
        p1Score.text = "Score: " + m_Tanks[0].m_Wins;
        p2Score.text = "Score: " + m_Tanks[1].m_Wins;
    }
